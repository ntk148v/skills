...
- The user mentions "skill creation" or "writing skills"
...
- Start with "Use when..."
- Describe ONLY when to use (NOT what it does)
...
The description should ONLY describe triggering conditions. Do NOT summarize the skill's workflow in the description.
